...
{
    public partial class SmokeMachineSalesData : Form
    {
        ...
        {
            xmlPath = "C:\\xmlFile\\" + this.strUserName + "\\SmokeMachineSalesData.xml";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            insertMap.Clear();
            xml.Save("C:\\xmlFile\\" + this.strUserName + "\\SmokeMachineSalesData.xml");
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            if (this.checkforInterface("SmokeMachine"))
            {
                ...
                smokeMachine.setProductModel(this.comboBox2.Text);
                smokeMachine.setUserName(this.strUserName);
                smokeMachine.Show();
            }
        }

        private void SmokeMachineSalesData_FormClosed(object sender, FormClosedEventArgs e)
        {
            FormCollection fc = Application.OpenForms;
            if (1 == fc.Count)
            {
