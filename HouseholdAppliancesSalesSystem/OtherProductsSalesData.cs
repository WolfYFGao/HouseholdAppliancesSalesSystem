...
{
    public partial class OtherProductsSalesData : Form
    {
        ...
        private void OtherProductsSalesData_Load(object sender, EventArgs e)
        {
            xmlPath = "C:\\xmlFile\\" + this.strUserName + "\\OtherProductsSalesData.xml";
        ...
        private void OtherProductsSalesData_FormClosed(object sender, FormClosedEventArgs e)
        {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            insertMap.Clear();
            xml.Save("C:\\xmlFile\\" + this.strUserName + "\\OtherProductsSalesData.xml");
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (this.checkforInterface("OtherProducts"))
            {
                ...
                otherProducts.setProductModel(this.comboBox2.Text);
